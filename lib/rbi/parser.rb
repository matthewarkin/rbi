...
module RBI
  ...
  class Parser
    ...
    class << self
      ...
      #: (T::Array[String] paths) -> T::Array[Tree]
      def parse_files(paths)
        parser = Parser.new
        paths.map { |path| parser.parse_file(path) }
      end

      #: (T::Array[String] strings) -> T::Array[Tree]
    ...
    class TreeBuilder < Visitor
      ...
      #: (String source, comments: T::Array[Prism::Comment], file: String) -> void
      ...
      #: (T::Array[Sig] sigs) -> T::Array[Comment]
      ...
      #: (Prism::Node node) -> T::Array[Comment]
