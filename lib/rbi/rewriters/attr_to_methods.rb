...
module RBI
  ...
  module Rewriters
    class AttrToMethods < Visitor
      ...
      #: (Node node, with: T::Array[Node]) -> void
  ...
  class Attr
    ...
    #: (String name, Sig? sig, Visibility visibility, Loc? loc, T::Array[Comment] comments) -> Method
    ...
    #: (String name, Sig? sig, (Type | String)? attribute_type, Visibility visibility, Loc? loc, T::Array[Comment] comments) -> Method
